<?php
	...
	if($op=='display'){
		wl_load()->model('goods');
		wl_load()->model('order');
		$data1 = goods_get_list(array('ishows'=>'1,2,3','orderby'=>' order by salenum desc limit 0,9 '));
		$data2 = goods_get_list(array('ishows'=>' 1,2,3 ','orderby'=>' order by pv desc limit 0,9 '));
		$data3 = goods_get_list(array('ishows'=>' 1,2,3 ','orderby'=>' order by uv desc limit 0,9 '));
		$labels = array();
		$labels2 = array();
		$labels3 = array();
		$salenum =array();
