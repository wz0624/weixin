...
class backlist{
	...
	function getModuleFrames($name){
		...
		$frames['order']['items']['statistics']['url'] = url('site/entry/statistics/',array('m'=>$name));
		$frames['order']['items']['statistics']['title'] = '订单概况';
		$frames['order']['items']['statistics']['actions'] = array();
		$frames['order']['items']['statistics']['active'] = '';
		
		$frames['order']['items']['order']['url'] = url('site/entry/order/',array('m'=>$name));
		$frames['order']['items']['order']['title'] = '线上订单';
