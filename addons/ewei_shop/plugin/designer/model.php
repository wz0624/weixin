...
if (!class_exists('DesignerModel')) {
    class DesignerModel extends PluginModel
    {
	    ...
	    if (strexists($page['datas'], '{')) {
	            $page['datas'] = htmlspecialchars_decode($page['datas']);
	    } else {
	            $page['datas'] = htmlspecialchars_decode(base64_decode($page['datas']));
	    }
        ...
        public function getData($page)
        {
            ...
            if (strexists($page["datas"], "{")) {
                ...
                $date = htmlspecialchars_decode(base64_decode($page["datas"]));
            }
            ...
            $data           = rtrim($data, "]");
            $data           = ltrim($data, "[");
            if (strexists($page["pageinfo"], "{")) {
                $pageinfo = htmlspecialchars_decode($page["pageinfo"]);
            } else {
                $pageinfo = htmlspecialchars_decode(base64_decode($page["pageinfo"]));
            }
