...
var 苦项目层;
var 苦星控制;
var bgmusic=new MusicObject("/addons/tiger_paobunan/template/mobile/audio/bgmusic.mp3",true);
var 苦加载数据 = [
{name : "num_0",path : "/addons/tiger_paobunan/template/mobile/images/num_0.png"}, 
{name : "num_1",path : "/addons/tiger_paobunan/template/mobile/images/num_1.png"}, 
{name : "num_2",path : "/addons/tiger_paobunan/template/mobile/images/num_2.png"}, 
{name : "num_3",path : "/addons/tiger_paobunan/template/mobile/images/num_3.png"}, 
{name : "num_4",path : "/addons/tiger_paobunan/template/mobile/images/num_4.png"}, 
{name : "num_5",path : "/addons/tiger_paobunan/template/mobile/images/num_5.png"}, 
{name : "num_6",path : "/addons/tiger_paobunan/template/mobile/images/num_6.png"}, 
{name : "num_7",path : "/addons/tiger_paobunan/template/mobile/images/num_7.png"}, 
{name : "num_8",path : "/addons/tiger_paobunan/template/mobile/images/num_8.png"}, 
{name : "num_9",path : "/addons/tiger_paobunan/template/mobile/images/num_9.png"}, 
{name : "effect",path : "/addons/tiger_paobunan/template/mobile/images/effect.png"}, 
{name : "logo",path : "/addons/tiger_paobunan/template/mobile/kaishi.jpg"}, 
{name : "inputbox",path : "/addons/tiger_paobunan/template/mobile/images/inputbox.png"}, 
{name : "spiritEffect",path : "/addons/tiger_paobunan/template/mobile/images/spiritEffect.png"}, 
{name : "b_background",path : "/addons/tiger_paobunan/template/mobile/beijing.jpg"}, 
{name : "m_background",path : "/addons/tiger_paobunan/template/mobile/images/m_background.png"}, 
{name : "stage",path : "/addons/tiger_paobunan/template/mobile/images/stage.png"}, 
{name : "chara",path : "/addons/tiger_paobunan/template/mobile/images/chara.png"}, 
{name : "bird",path : "/addons/tiger_paobunan/template/mobile/images/bird.png"}, 
{name : "gui",path : "/addons/tiger_paobunan/template/mobile/images/gui.png"}, 
{name : "window",path : "/addons/tiger_paobunan/template/mobile/shibai.jpg"}, 
{name : "HP_bg",path : "/addons/tiger_paobunan/template/mobile/images/hp_bg.png"},  
{name : "HP_value",path : "/addons/tiger_paobunan/template/mobile/images/hp_value.png"},
];
