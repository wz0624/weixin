$(document).ready(function() {
    var a=$(".no").html()
    for(i=0;i<a;i++){
        $(".list").append('<img src="../addons/hc_chuansong/images/anmanPai.png" alt="">') 
    }
    if(a>0){
   ...
   /* $(".mask").click(function(event) {
       ...
       $(".list img").eq(t).attr("src","../addons/hc_chuansong/images/anmanBai.png")
    });*/
    ...
    $(".list img").click(function(event) {
       ...
       $(".list img").eq(tt).attr("src","../addons/hc_chuansong/images/anmanBai.png")
       });
       $(".mask").click(function(event) {
       $(this).css('display', 'none');
       var t=$(this).attr("mate-data")
