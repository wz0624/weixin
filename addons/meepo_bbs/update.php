...
if(!pdo_tableexists('ims_meepo_common_adv')) {
 $sql = " CREATE TABLE IF NOT EXISTS `ims_meepo_common_adv` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) unsigned NOT NULL DEFAULT '0',
...
if(!pdo_tableexists('ims_meepo_common_setting')){
 $sql = " CREATE TABLE IF NOT EXISTS `ims_meepo_common_setting` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `module` varchar(32) NOT NULL DEFAULT '',
  `uniacid` int(11) unsigned NOT NULL DEFAULT '0',
  `set` text NOT NULL,
...
if(!pdo_tableexists('ims_meepo_bbs_fans')){
 $sql = " CREATE TABLE IF NOT EXISTS `ims_meepo_bbs_fans` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
