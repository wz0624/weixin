...
class Activity{
    ...
    public function create($entity){
        global $_W;
        $rec = array_elements(array('title','description','shareimg','content','singleimg','status','extype','starttime','endtime','place','proname','tlimit','fee','author','groups','viewnums'), $entity);
