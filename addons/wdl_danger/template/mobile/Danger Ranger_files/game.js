...
function createSprites()
{
	try
	{
		...
		g.splash		= new Image();	g.splash.src		= "../addons/wdl_danger/template/mobile/library/splash.png";
		g.playpause		= new Image();	g.playpause.src		= "../addons/wdl_danger/template/mobile/library/playpause.png";
		g.gameback		= [];
		g.gameback[0]	= new Image();	g.gameback[0].src	= "../addons/wdl_danger/template/mobile/library/gameback1.gif";
		g.gameback[1]	= new Image();	g.gameback[1].src	= "../addons/wdl_danger/template/mobile/library/gameback2.gif";
		g.gameback[2]	= new Image();	g.gameback[2].src	= "../addons/wdl_danger/template/mobile/library/gameback3.gif";
		
		//g.volumecontrol = new Image(); g.volumecontrol.src = "../addons/wdl_danger/template/mobile/library/volumecontrols.png";
