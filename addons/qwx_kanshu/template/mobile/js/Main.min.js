function main() {
    ...
    jsGame.initImage([{
        id: "a",
        src: "../addons/qwx_kanshu/template/mobile/img/a.png"
    }, {
        id: "back0",
        src: "../addons/qwx_kanshu/template/mobile/img/back0.jpg"
    }, {
        id: "tree0",
        src: "../addons/qwx_kanshu/template/mobile/img/tree0.png"
    }, {
        id: "leaf0",
        src: "../addons/qwx_kanshu/template/mobile/img/leaf0.png"
    }, {
        id: "leaf0L",
        src: "../addons/qwx_kanshu/template/mobile/img/leaf0L.png"
    }, {
        id: "stump0",
        src: "../addons/qwx_kanshu/template/mobile/img/stump0.png"
    }, {
        id: "back1",
        src: "../addons/qwx_kanshu/template/mobile/img/back1.jpg"
    }, {
        id: "tree1",
        src: "../addons/qwx_kanshu/template/mobile/img/tree1.png"
    }, {
        id: "leaf1",
        src: "../addons/qwx_kanshu/template/mobile/img/leaf1.png"
    }, {
        id: "leaf1L",
        src: "../addons/qwx_kanshu/template/mobile/img/leaf1L.png"
    }, {
        id: "stump1",
        src: "../addons/qwx_kanshu/template/mobile/img/stump1.png"
    }, {
        id: "man0",
        src: "../addons/qwx_kanshu/template/mobile/img/man0.png"
    }, {
        id: "man1",
        src: "../addons/qwx_kanshu/template/mobile/img/man1.png"
    }, {
        id: "man2",
        src: "../addons/qwx_kanshu/template/mobile/img/man2.png"
    }, {
        id: "man3",
        src: "../addons/qwx_kanshu/template/mobile/img/man3.png"
    }, {
        id: "man0L",
        src: "../addons/qwx_kanshu/template/mobile/img/man0L.png"
    }, {
        id: "man1L",
        src: "../addons/qwx_kanshu/template/mobile/img/man1L.png"
    }, {
        id: "man2L",
        src: "../addons/qwx_kanshu/template/mobile/img/man2L.png"
    }, {
        id: "man3L",
        src: "../addons/qwx_kanshu/template/mobile/img/man3L.png"
    }, {
        id: "dead",
        src: "../addons/qwx_kanshu/template/mobile/img/dead.png"
    }, {
        id: "arrow",
        src: "../addons/qwx_kanshu/template/mobile/img/arrow.png"
    }, {
        id: "arrowL",
        src: "../addons/qwx_kanshu/template/mobile/img/arrowL.png"
    }, {
        id: "hp",
        src: "../addons/qwx_kanshu/template/mobile/img/hp.png"
    }, {
        id: "hp2",
        src: "../addons/qwx_kanshu/template/mobile/img/hp2.png"
    }, {
        id: "hpbar",
        src: "../addons/qwx_kanshu/template/mobile/img/hpbar.png"
    }, {
        id: "menu",
        src: "../addons/qwx_kanshu/template/mobile/img/menu.png"
    }, {
        id: "num",
        src: "../addons/qwx_kanshu/template/mobile/img/num.png"
    }, {
        id: "btnRank",
        src: "../addons/qwx_kanshu/template/mobile/img/btnRank.png"
    }, {
        id: "btnPlay",
        src: "../addons/qwx_kanshu/template/mobile/img/btnPlay.png"
    }, {
        id: "btnShare",
        src: "../addons/qwx_kanshu/template/mobile/img/btnShare.png"
    }, {
        id: "btnSound",
        src: "../addons/qwx_kanshu/template/mobile/img/sound.png"
    }, {
        id: "btnMore",
        src: "../addons/qwx_kanshu/template/mobile/img/duopao.png"
    }, {
        id: "btnMiji",
        src: "../addons/qwx_kanshu/template/mobile/img/btnmiji.png"
    }, {
        id: "title",
        src: "../addons/qwx_kanshu/template/mobile/img/title.png"
    ...
    jsGame.init(640, 1136).pageLoad(function (b) {
        ...
        function M(a) {
            ...
            if (0 == h || 1 == h) f.isPressed && k(f, a.x, a.y) ? (y = 1 == y ? 0 : 1, jsGame.localStorage.setItem("timbermansound", y), f.isPressed = !1) : e.isPressed && k(e, a.x, a.y) && (window.location.href = "http://game.apiwck.com/", e.isPressed = !1);
                ...
                z = -1;
                q.isPressed = !1
            } else m.isPressed && k(m, a.x, a.y) ? (share(v, z), m.isPressed = !1) : n.isPressed && k(n, a.x, a.y) ? (window.location.href = window.location.href, n.isPressed = !1) : p.isPressed && k(p, a.x, a.y) && (dp_Ranking(), p.isPressed = !1)
        }
