...
TouchScroll.prototype={
	...
	resize:function(){
		...
		this.bannerHeight=document.getElementById('touchscrollelement').height;
		this.element=this.$C('div',{'class':'touchscrollelement','id':'touchscrollelement','style':';overflow:hidden;width:'+this.scrollWidth+'px;padding:'+parseInt(barHeight/2)+'px '+parseInt(barWidth/2)+'px;position:absolute;top:-'+this.container.scrollTop+'px;left:-'+this.container.scrollLeft+'px;'});
		
		this.wrapper=this.$C('div',{'class':'touchscrollwrapper','style':';overflow:hidden;position:relative;width:100%;height:'+this.bannerHeight+'px;'});
